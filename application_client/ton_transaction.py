...
class JettonTransferPayload(Payload):
    ...
    def to_request_bytes(self) -> bytes:
        ...
        print("flags :", flags)
        print("big info",self.query_id.to_bytes(8, byteorder="big").hex())
        main_body = b"".join([
            bytes([flags]),
        ...
        # print("am--->",write_varuint(self.forward_amount).hex())
        # print("len body", len(main_body))
        # print("body-->", main_body.hex())
        return b"".join([
